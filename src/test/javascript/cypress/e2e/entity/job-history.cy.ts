...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2023-02-20T13:28').blur().should('have.value', '2023-02-20T13:28');

      cy.get(`[data-cy="endDate"]`).type('2023-02-20T23:04').blur().should('have.value', '2023-02-20T23:04');
