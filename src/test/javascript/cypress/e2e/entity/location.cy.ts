...
describe('Location e2e test', () => {
  ...
  describe('new Location page', () => {
    ...
    it('should create an instance of Location', () => {
      cy.get(`[data-cy="streetAddress"]`).type('upright').should('have.value', 'upright');

      cy.get(`[data-cy="postalCode"]`).type('Mini initiatives alarm').should('have.value', 'Mini initiatives alarm');

      cy.get(`[data-cy="city"]`).type('Lake Kendallside').should('have.value', 'Lake Kendallside');

      cy.get(`[data-cy="stateProvince"]`).type('Associate VGA Metal').should('have.value', 'Associate VGA Metal');
