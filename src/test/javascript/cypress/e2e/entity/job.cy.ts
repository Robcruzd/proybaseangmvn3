...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('Legacy Data Associate').should('have.value', 'Legacy Data Associate');

      cy.get(`[data-cy="minSalary"]`).type('59434').should('have.value', '59434');

      cy.get(`[data-cy="maxSalary"]`).type('93205').should('have.value', '93205');
