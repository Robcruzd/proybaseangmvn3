...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="title"]`).type('application Frozen').should('have.value', 'application Frozen');

      cy.get(`[data-cy="description"]`).type('interactive').should('have.value', 'interactive');
