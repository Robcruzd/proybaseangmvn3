...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('Manuela').should('have.value', 'Manuela');

      cy.get(`[data-cy="lastName"]`).type('Zemlak').should('have.value', 'Zemlak');

      cy.get(`[data-cy="email"]`).type('Dominique_Pfannerstill@yahoo.com').should('have.value', 'Dominique_Pfannerstill@yahoo.com');

      cy.get(`[data-cy="phoneNumber"]`).type('F2M growling').should('have.value', 'F2M growling');

      cy.get(`[data-cy="hireDate"]`).type('2023-02-21T05:48').blur().should('have.value', '2023-02-21T05:48');

      cy.get(`[data-cy="salary"]`).type('62062').should('have.value', '62062');

      cy.get(`[data-cy="commissionPct"]`).type('47157').should('have.value', '47157');
