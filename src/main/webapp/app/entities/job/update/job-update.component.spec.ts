...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 73002 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 53014 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 62384 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 16237 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 33523 };
      job.tasks = [task];
      const employee: IEmployee = { id: 55794 };
      job.employee = employee;
