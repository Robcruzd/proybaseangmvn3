...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Job query and add missing value', () => {
      ...
      const job: IJob = { id: 44822 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 92308 }];
    ...
    it('Should call Department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 3218 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 80422 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 81533 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 17451 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 47896 };
      jobHistory.job = job;
      const department: IDepartment = { id: 50186 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 37384 };
      jobHistory.employee = employee;
